...
Purpose:
    ...
    to move data from the Bronze layer to the Silver layer.

Operations Performed:
    - Applying Data cleansing and Transformation to the table
    - Truncating and storing the table
    - Loads the processed data from Bronze tables into Silver tables.

Parameters:
    None.
    This procedure does not accept any input parameters and does not return
    any values.
